SELECT IsNull( String( bethadba.FOVIGENCIAS_SERVICO.codi_emp ), 'NULO'),
...
ORDER BY bethadba.FOVIGENCIAS_SERVICO.codi_emp ASC, 
         bethadba.FOVIGENCIAS_SERVICO.i_servicos ASC